...
example-python: gohttp/_gohttplib.py
...
gohttp/libgohttp.so: build/libgohttp.so
	cp $< $@

gohttp/_gohttplib.py: examples/python/gohttp/build_gohttplib.py examples/python/gohttp/libgohttp.so
